...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net objectbuffer_0_BRAM_PORT_B [get_bd_intf_pins axi_bram_ctrl_0_bram/BRAM_PORTB] [get_bd_intf_pins objectbuffer_0/BRAM_PORT_B]
  ...
  connect_bd_net -net clk_wiz_0_pixelclock [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins clk_wiz_0/pixelclock] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rgb2tmds_0/pixelclock] [get_bd_pins vtg_0/clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins objectbuffer_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
